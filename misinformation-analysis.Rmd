...
```
In the sample,there is a moderate positive correlation between relying on Facebook for knowledge about coronavirus and number of misinformation beliefs,rs(498)=0.23, p<0.001.
